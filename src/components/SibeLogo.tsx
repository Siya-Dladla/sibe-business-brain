...
const SibeLogo = ({ className, size = "md" }: SibeLogoProps) => {
  ...
  return (
    <div
      className={cn(
        "relative rounded-xl bg-gradient-to-br from-primary via-primary/80 to-accent flex items-center justify-center shadow-lg shadow-primary/20",
        sizeClasses[size],
        className
      )}
    >
      ...
      {/* AI indicator dot */}
      <div className={cn(
        "absolute bg-emerald-400 rounded-full border-2 border-background animate-pulse",
