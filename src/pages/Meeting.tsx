...
const Meeting = () => {
  ...
  return <div className="min-h-screen bg-background grid-bg">
      ...
      <div className="container mx-auto px-6 py-8 bg-primary-foreground">
        ...
        {loading ? <Card className="glass-card p-16 flex flex-col items-center justify-center min-h-[400px] border-primary/20 bg-primary-foreground">
          ...
          </Card> : meetings.length === 0 ? <Card className="glass-card p-16 flex flex-col items-center justify-center min-h-[500px] hover-lift border-primary/20">
